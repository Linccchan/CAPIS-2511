...
-- v2: customer filter now matches documents_status_check vocabulary
--     (required | uploaded | verified | missing) — customers see only
--     documents with an actual file (uploaded/verified), not placeholders.
--
...
-- uploaded/verified documents belonging to their own orders;
-- admin/sales/management read all. Staff INSERT/UPDATE policies come with
-- the admin Document Manager (Module 2).
